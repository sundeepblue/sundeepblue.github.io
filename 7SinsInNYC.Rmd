...
Safety is one of the most fundamental human needs. No one wants to involve with any incidents in NYC and be unsafe. This report investigated 7 felonies in New York City occurred in the past ten years (2006-2015). As such, I mainly focus on answering the following questions:
...
5. According to historical data, which places are more unsafe than others?
...
According to the [NYPD Incident Level Data Footnotes](https://nycopendata.socrata.com/api/views/dvh8-u7es/files/2cb20832-af65-45d4-aa04-9097212581f8?download=true&filename=NYPDIncidentLevelDataFootnotes.pdf), two points are worth mentioning:
...
# Insights
Now the answer of the proposed questions are as follows.
...
* In the evening (7pm - 10pm), felony assult, larceny of motor vehicle, robbery, and murder occur more often.

* In middle night (11pm - 3am), felony assult, rape, robbery, murder occurs more often.
